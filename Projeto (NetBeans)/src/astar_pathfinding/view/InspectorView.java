...
public class InspectorView extends JPanel implements Observer {
	...
	lblX_value.setToolTipText("<html>Posição <b>X</b> do Nodo selecionado.</html>");
	lblY_value = new JLabel();
	lblY_value.setHorizontalAlignment(JLabel.CENTER);
	lblY_value.setToolTipText("<html>Posição <b>Y</b> do Nodo selecionado.</html>");
	btnEstadoDoNodo = new JButton();
	btnEstadoDoNodo.setToolTipText("<html>Atalho: <b>CTRL + Botão Direito do Mouse</b> no Nodo que deseja <b>habilitar/desabilitar</b><br/>Atalho:"
		+ " Pressione <b>H</b> ao selecionado o Nodo que deseja <b>habilitar/desabilitar</b>.</html>");
	...
	btnDefinirPontoInicial = new JButton("<html>Definir <b>Ponto de Origem</b></html>");
	btnDefinirPontoInicial.setToolTipText("<html>Define o <b>Nodo selecionado</b> como o Nodo <b>origem</b> da busca.<br/>Atalho: Pressione a tecla <b>1</b> do teclado.</html>");
	...
	btnDefinirPontoFinal = new JButton("<html>Definir <b>Ponto de Destino</b></html>");
	btnDefinirPontoFinal.setToolTipText("<html>Define o <b>Nodo selecionado</b> como o Nodo <b>destino</b> da busca.<br/>Atalho: Pressione a tecla <b>2</b> do teclado.</html>");
	...
	cbmi.setToolTipText("<html><b>Habilita</b> o <b>movimento diagonal</b> na busca.</html>");
	...
	cbmv = new JCheckBox("<html>Mostrar valores <b>G</b>, <b>H</b> e <b>F</b></html>");
	cbmv.setToolTipText("<html>Apresenta os valores <b>G</b>, <b>H</b> e <b>F</b> na <i>grid</i>.</html>");
