...
public class AStarJFrame extends JFrame {
	...
	StringBuilder sb = new StringBuilder("<html>A <b>execução</b> do algoritmo A* durou <b>" + nanosseconds + " nanossegundos</b>.");
	...
	jmiSobre.addActionListener(new ActionListener() {
	    ...
	    {
		if (sobreJframe == null) sobreJframe = new SobreJFrame();
